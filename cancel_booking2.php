...
<body>
    <br><br>
    <CENTER><h1>โปรไฟล์ของคุณ</h1></CENTER>
...
<br>
<!-- ส่วนที่ใช้แสดงประวัติการจอง -->
<h2 class="text-primary">ประวัติยกเลิกการจอง</h2>
...
<table  class="table">
 ...
 <!-- ตรวจสอบว่ามี comment หรือไม่ หากมีก็ข้ามไป -->
                <tr>
