            ...
            <div class="container py-5">
                <div class="row justify-content-center py-5">
                    <div class="col-lg-10 pt-lg-5 mt-lg-5 text-center">
                        <h1 href="contactlog.php" class="display-3 text-white animated slideInDown">ติดต่อเรา</h1>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                ...
                <h1 class="mb-5">ข้อมูล ติดต่อเรา</h1>
            </div>
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <h5>Contact</h5>
                    <p class="mb-4">หมู่บ้าน ทางหลวงชนบท หนองคาย 3035 ตำบล โพธิ์ตาก อำเภอ โพธิ์ตาก หนองคาย 43130</p>
                    <div class="d-flex align-items-center mb-4">
                        ...
                        <div class="ms-3">
                            ...
                            <p class="mb-0">หมู่บ้าน ทางหลวงชนบท หนองคาย 3035 ตำบล โพธิ์ตาก อำเภอ โพธิ์ตาก หนองคาย 43130</p>
                        </div>
                    </div>
                    <div class="d-flex align-items-center mb-4">
                        <div class="d-flex align-items-center justify-content-center flex-shrink-0 bg-primary" style="width: 50px; height: 50px;">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <iframe class="position-relative rounded w-100 h-100"
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d975960.0006937997!2d102.02609797023192!3d17.15348146900353!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31240d56f8ade0d5%3A0x5bf7d3dacdf8c1ed!2z4LiK4Li44Lih4LiK4LiZ4LiX4LmI4Lit4LiH4LmA4LiX4Li14LmI4Lii4Lin4Lia4LmJ4Liy4LiZ4LmC4Lie4LiY4Li04LmM4LiV4Liy4LiB!5e0!3m2!1sth!2sth!4v1697551565523!5m2!1sth!2sth"
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <div class="form-floating">
                                    ...
                                    <label for="subject">เบอร์โทรศัพท์</label>
                                </div>
                            </div>
                            <div class="col-12">
                                <h6>ข้อความ</h6>
