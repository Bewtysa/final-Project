                ...
                <a href="index.php" class="nav-item nav-link">หน้าแรก</a>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-0">
                            ...
                            <a href="profilr.php" class="dropdown-item">โปรไฟล์</a>
                ...
                <div class="container py-5">
                    <div class="row justify-content-center py-5">
                        <div class="col-lg-10 pt-lg-5 mt-lg-5 text-center">
                            <h1 class="display-3 text-white animated slideInDown">เข้าสู่ระบบ</h1>
    ...
    <div class="position-relative mx-auto" style="max-width: 400px;">
        ...
        <div class=" card  mt-2 shadow p-3 mb-5 bg-white rounded">
            ...
            <?php } ?>
                ...
                <div class="position-relative mx-auto" style="max-width: 400px;">
                    <h1><button type="submit" name="signin" class="btn btn-primary">เข้าสู่ระบบ</button></h1>
                    <hr>
                    <p>หากยังไม่เป็นสมาชิก กดปุ่มนี้เพื่อ <a href="register.php"  class="nav-item">สมัครสมาชิก</a></p>
