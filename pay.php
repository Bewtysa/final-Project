    ...
    <div class="container-xxl py-5">
        ...
        <div class="container">
            ...
            <div class="text-center wow ">
                ...
                <h1 class="mb-5">ช่องทางการชำระเงิน
                </h1>

                <a href="pay.php" class="btn btn-warning">พร้อมเพย์</a> 
                <a href="pay2.php" class="btn btn-warning">QR Code </a><br><br><br><br><br>
                
                 
                <h1 class="mb-2">094-512-xxxx</h1><br><br>
                <a href="profile.php" class="btn btn-primary">ถัดไป</a> 
            </div>
